    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          { label: 'ZIEL', value: nutrition.targetCalories, color: '#d4ff00' },
        ].map((item) => (
      ...
      <div className="bg-[#0a0a0d] border border-[#2a2a35] rounded-xl p-5 space-y-4">
        <h4 className="font-mono font-bold text-[#e8e8e8] text-sm uppercase tracking-wider">Tägliche Makros</h4>
        <MacroBar label="Protein" value={macros.protein} unit="g" pct={Math.round((macros.protein*4/totalCals)*100)} color="#d4ff00" />
        <MacroBar label="Kohlenhydrate" value={macros.carbs} unit="g" pct={Math.round((macros.carbs*4/totalCals)*100)} color="#00c8ff" />
        <MacroBar label="Fett" value={macros.fat} unit="g" pct={Math.round((macros.fat*9/totalCals)*100)} color="#ff6b35" />
      </div>

      {/* Timing */}
      <div className="bg-[#0a0a0d] border border-[#2a2a35] rounded-xl p-5 space-y-4">
        <h4 className="font-mono font-bold text-[#e8e8e8] text-sm uppercase tracking-wider">Mahlzeitenzeiten</h4>
        <div className="space-y-3">
          <div className="border-l-2 border-[#d4ff00] pl-3">
            <p className="text-xs font-mono text-[#d4ff00] uppercase tracking-wider mb-1">Vor dem Training</p>
            <p className="text-sm font-mono text-[#888]">{nutrition.preworkout}</p>
          </div>
          <div className="border-l-2 border-[#00c8ff] pl-3">
            <p className="text-xs font-mono text-[#00c8ff] uppercase tracking-wider mb-1">Nach dem Training</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-[#0a0a0d] border border-[#2a2a35] rounded-xl p-5">
          <h4 className="font-mono font-bold text-[#e8e8e8] text-sm uppercase tracking-wider mb-3">💧 Flüssigkeitszufuhr</h4>
          <p className="text-sm font-mono text-[#888]">{nutrition.hydration}</p>
        </div>
        <div className="bg-[#0a0a0d] border border-[#2a2a35] rounded-xl p-5">
          <h4 className="font-mono font-bold text-[#e8e8e8] text-sm uppercase tracking-wider mb-3">💊 Nahrungsergänzung</h4>
