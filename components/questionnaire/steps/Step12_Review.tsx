...
function Row({ label, value }: RowProps) {
  return (
    <div className="flex justify-between items-center py-2 border-b border-[#1e1b4b] last:border-0">
      <span className="text-xs font-mono text-[#8080a8] uppercase tracking-wider">{label}</span>
...
export function Step12_Review() {
  ...
  return (
    <StepWrapper step={step} title="Überprüfe deine Angaben." subtitle="Alles korrekt? Du kannst zurückgehen und Anpassungen vornehmen."
      ...
      <div className="bg-[#13132a] border border-[#2d2b55] rounded-xl p-5 space-y-1">
