    ...
    <StepWrapper step={step} title="Cardio & Konditionierung." onNext={nextStep} onBack={prevStep}>
      <div className="space-y-6">
        <div className="space-y-3">
          <p className="text-xs font-mono text-[#888] uppercase tracking-wider">Cardio einbeziehen?</p>
        ...
        {inputs.includeCardio && (
          <div className="space-y-3">
            <p className="text-xs font-mono text-[#888] uppercase tracking-wider">Cardio-Stil</p>
