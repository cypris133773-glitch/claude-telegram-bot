    ...
    <StepWrapper step={step} title="Tägliche Aktivität & Erholung." onNext={nextStep} onBack={prevStep}>
      <div className="space-y-8">
        <div className="space-y-3">
          <p className="text-xs font-mono text-[#8080a8] uppercase tracking-wider">Aktivitätslevel außerhalb des Gyms</p>
          <div className="space-y-3">
        ...
        <div className="space-y-3">
          <p className="text-xs font-mono text-[#8080a8] uppercase tracking-wider">
